...
int i=0;
int card1[4]{180,129, 199,7};
int card2[4]{144,121,131,38};
int card3[4]{180,123,223,7};
int card4[4]{144,244,159,38};
...
void setup() {
  ...
  Serial.println("  RFID & KEYPAD ");
  lcd.setCursor(0,1);
  lcd.print("  Lock Project  "); 
  Serial.println("  Lock Project  ");
  lcd.clear();   
